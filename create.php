...
echo "\n";
echo "DOMAIN CUSTOM NYA APA GAN?\n";
echo "(BIAR EMAIL MU KEREN GAN HAHA)\n";
echo "misal: gmail, azzamgans, sgbteam\n";
echo "-> " ;
$asal = trim(fgets(STDIN));
echo "\n";
echo "DOMAINNYA MAU APA GAN?\n";
echo "(BIAR EMAIL MU KEREN GAN HAHA)\n";
echo "misal co / com / me / id dan gausah pake titik\n";
echo "-> " ;
